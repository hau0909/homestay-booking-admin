...
import {
  getAllBookings,
  BookingWithDetails,
} from "@/src/services/booking/getAllBookings";
...
export default function AdminBookingsPage() {
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
            <TabsList className="bg-white border p-1 rounded-xl h-auto">
              <TabsTrigger
                value="ALL"
                className="px-4 py-2 rounded-lg text-sm font-semibold transition-all data-[state=active]:bg-[#11009E] data-[state=active]:text-white"
              >
                All
              </TabsTrigger>
              <TabsTrigger
          ...
          <TabsContent
            value={activeTab === "LOGS" ? "LOGS-INACTIVE" : activeTab}
            className="mt-0"
          >
            ...
            <div className="rounded-xl border bg-white overflow-hidden shadow-sm">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="w-16 italic text-muted-foreground">
                      #
                    </TableHead>
                    ...
                    <TableHead className="w-20 text-center italic text-muted-foreground">
                      View
                    </TableHead>
                  </TableRow>
                </TableHeader>
                      ...
                      >
                        ...
                        <TableCell>
                          <div
                            ...
                            title={booking.listing_title || "Unknown"}
                          >
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="italic text-muted-foreground w-32">
                      Booking ID
                    </TableHead>
                    <TableHead className="italic text-muted-foreground">
                      Booking Status
                  ...
                  {loading ? (
                    ...
                    filteredLogs.map((log) => (
                      <TableRow
                        ...
                        className="hover:bg-slate-50 transition-colors"
                      >
                        <TableCell className="font-semibold text-[#11009E]">
                          #{log.id}
                        </TableCell>
      ...
      {selectedBooking && (
        <div
          className="fixed inset-0 bg-black/60 z-50 flex justify-center items-start overflow-y-auto py-10"
          onClick={() => setSelectedBooking(null)}
        >
          <div
            className="bg-white w-full max-w-3xl mx-4 rounded-2xl relative shadow-2xl p-8"
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <InfoItem label="Client Name">
                    {selectedBooking.guest_name || "Unknown"}
                  </InfoItem>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <InfoItem label="Property">
                    {selectedBooking.listing_title ||
                      `Listing #${selectedBooking.listing_id}`}
                  </InfoItem>
                  <InfoItem label="Total Amount">
                    ${selectedBooking.total_price?.toLocaleString() ?? 0}
                  </InfoItem>
                  <InfoItem label="Host Name">
                    {selectedBooking.host_name || "N/A"}
                  </InfoItem>
                  <InfoItem label="Host Phone">
                    {selectedBooking.host_phone || "N/A"}
                  </InfoItem>
...
function StatusBadge({
  ...
  if (type === "booking") {
    ...
    else style = "bg-gray-100 text-gray-600 border-gray-200";
  } else {
    if (upperStatus === "PAID")
